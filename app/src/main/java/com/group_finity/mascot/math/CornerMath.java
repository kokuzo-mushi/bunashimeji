...
public class CornerMath {
     ...
     */
    public static NeoPoint calculateAnchorPosition(NeoPoint corner, NeoPoint wallAnchor, NeoPoint ceilingAnchor,
            boolean isLeftWall, double progress, double xRadius) {
        // 角度: 0 -> 90度 (PI/2)
        ...
        return new NeoPoint(finalX, finalY);
    }
}